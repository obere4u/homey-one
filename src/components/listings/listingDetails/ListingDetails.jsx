   ...
   return (
    <div className="w-full ">
      ...
      <div className="flex justify-start items-center space-x-4 ">
        <p className=" bg-red-800 w-full rounded-md p-1.5 text-white text-center font-semibold shadow-md">
          {type === "rent" ? "Rent" : "Sale"}
        </p>
        {offer ? (
          <div className=" bg-green-800 w-full  rounded-md p-1.5 text-white text-center font-semibold shadow-md">

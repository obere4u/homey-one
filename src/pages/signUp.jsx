...
export default function SignUp({isVisible}) {
  ...
  return (
    <section className="fixed inset-0 bg-black bg-opacity-50 flex justify-center items-center ">
      <div className=" flex flex-col w-[70%] bg-white mx-auto lg:w-[450px] md:w-[400px] sm:w-[400px] py-2 mt-4">
        <button className="text-lg font-bold text-black place-self-end mr-5 mt-2" >
        X</button>
        <h1 className="tracking-widest text-3xl text-center mt-5 font-bold ">
          Sign Up
        </h1>
